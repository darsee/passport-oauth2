...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  console.log('passport-oauth2 : callbackURL', callbackURL);
  ...
  if (callbackURL) {
    ...
    if (!parsed.protocol) {
      ...
      console.log('passport-oauth2 : callbackURL relative', callbackURL);
    }
  }
  ...
  if (req.query && req.query.code) {
    ...
    console.log('passport-oauth2 : params', params);
